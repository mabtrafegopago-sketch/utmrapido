  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="max-w-xl mx-auto px-4 pb-20 text-center">
        <p className="text-muted text-sm mb-3">Ainda tem dúvidas?</p>
        <a
          href="https://wa.me/55WHATSAPP_NUMBER"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 bg-[#25D366] text-white font-semibold px-6 py-3 rounded-xl hover:bg-[#1ebe5d] transition-colors text-sm shadow-sm"
        >
